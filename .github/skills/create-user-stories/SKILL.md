...
2. Use the GitHub MCP tools to list all open issues in this repository labelled `user-story`
   and read the full body of each one — these contain the technical decomposition,
   API shapes, data-testid values, and slice boundaries produced by the user-story-agent
